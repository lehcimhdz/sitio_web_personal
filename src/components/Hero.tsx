        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <a
              ...
              className="btn-secondary inline-flex items-center justify-center gap-2 border border-slate-700 hover:border-amber-400 text-slate-300 hover:text-amber-400 px-8 py-3 rounded-lg font-medium transition-all"
            >
              Contact Me
            </a>
          </motion.div>
          ...
          {/* Stat counters */}
          <motion.div
            className="flex flex-wrap gap-6 sm:gap-10 mb-10 pt-8 border-t border-slate-800/60"
